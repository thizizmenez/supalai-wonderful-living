  ...
  return (
    <section>
      <div className="bg-background starlight-bg py-16 px-6 text-center relative overflow-hidden">
        <p className="relative z-10 font-body text-sm md:text-lg text-foreground leading-relaxed">
          เพื่อให้ชีวิตของคุณที่นี่ <span className="font-display italic text-base md:text-xl gold-shimmer">Wonderful</span> <span className="text-foreground/80">ได้ทุกวัน</span>
        </p>
      </div>
