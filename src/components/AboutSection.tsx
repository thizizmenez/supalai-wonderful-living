      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-12">
        <div ref={r1} className={`reveal ${v1 ? 'visible' : ''}`}>
          <h2 className="font-display text-3xl md:text-5xl lg:text-6xl leading-tight mb-4">
            <span className="text-foreground">SUPALAI</span>{' '}
            <span className="text-gold-light">CONDOMINIUM</span>
          </h2>
        </div>
        ...
        <div ref={r3} className={`reveal reveal-delay-2 ${v3 ? 'visible' : ''} space-y-4`}>
          ...
          <p className="font-body text-base md:text-lg text-muted-foreground leading-relaxed">
            เราเลือกโลเคชั่นมาอย่างดี ตั้งใจออกแบบพื้นที่ในทุกห้อง มีส่วนกลางที่รองรับหลากหลายไลฟ์สไตล์<br />
