...
const ClosingSection = () => {
  ...
  return (
    <section ref={parallaxRef} className="parallax-section min-h-screen relative flex items-center justify-center">
      <div className="parallax-bg" style={{ backgroundImage: `url(${gallerySkyview})` }} />
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto space-y-10">
        ...
        <div ref={r2} className={`reveal reveal-delay-2 ${v2 ? 'visible' : ''}`}>
          <p className="font-body text-base md:text-lg text-muted-foreground leading-loose max-w-2xl mx-auto">
