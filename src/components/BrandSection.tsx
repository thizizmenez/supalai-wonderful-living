...
const brands = [
  ...
  { name: 'Supalai Blue Whale', logo: 'https://www.supalai.com/stocks/brand/d150x110/xs/pb/7xmtxspbtku/LOGO-SUPALAI-Blue-Whale-B1B.png', link: 'https://www.supalai.com/project/condo?brand=166453376660610' + UTM, scale: 'scale-90' },
        ...
        <div ref={gridRef} className={`${gridVisible ? '' : ''}`}>
          <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-6 gap-8">
            {brands.map((brand, i) => (
              ...
              >
                <div className="bg-white rounded-lg w-[250px] h-[110px] flex items-center justify-center px-3 py-4">
                  <img
                    src={brand.logo}
                    alt={brand.name}
