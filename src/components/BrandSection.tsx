...
const brands = [
  ...
  { name: 'Supalai Mare', logo: 'https://www.supalai.com/stocks/brand/d150x110/2o/bw/cvtq2obwdkl/MARE.png', link: 'https://www.supalai.com/project/condo?brand=1605506048038808' + UTM, scale: 'scale-[0.8]' },
